...
class LTC2945:
    ...
    def read(self):
        ...
        power_v = int.from_bytes(power, byteorder='big', signed=True)
        sense_v = int.from_bytes(sense, byteorder='big', signed=True)
        vin_v = int.from_bytes(vin, byteorder='big', signed=True)
